...
diabetes_model = pickle.load(open('./FYP/models/diabetes_model_u10.sav', 'rb'))

heart_model = pickle.load(open('./FYP/models/heart_model.sav', 'rb'))

liver_model = pickle.load(open('./FYP/models/liver_model_u.sav', 'rb'))

kidney_model = pickle.load(open('./FYP/models/kidney_model_u13.sav', 'rb'))
